      ...
      <div className="mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="p-5">
                <h3 className="text-lg font-medium text-gray-800 mb-3">How to Use</h3>
                <div className="space-y-3 text-sm">
                  <p className="text-gray-600">
                    Creative Vision AI transforms text descriptions into stunning images using advanced AI. Perfect for marketing materials, presentations, social media, or creative exploration.
                  </p>
                  
                  <div className="space-y-1">
                    <h4 className="font-medium text-gray-700">Features:</h4>
                    <ul className="list-disc pl-5 text-gray-600 space-y-1">
                      <li>Text-to-image generation with advanced AI models</li>
                      <li>Multiple style options and aspect ratios</li>
                      <li>Creative enhancement mode</li>
                      <li>Inspiration with sample prompts</li>
                      <li>Gallery of your generated images</li>
                    </ul>
                  </div>
                  
                  <div className="bg-blue-50 p-3 rounded text-blue-700 text-xs mt-3">
                    <div className="flex">
                      <Info size={14} className="mr-1 flex-shrink-0 mt-0.5" />
                      <span>
                        The more specific your prompt, the better the results. Include details about subjects, setting, style, mood, and lighting.
                      </span>
                    </div>
                  </div>
                </div>
