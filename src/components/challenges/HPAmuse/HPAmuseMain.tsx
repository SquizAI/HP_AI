  ...
  return (
    <div className="flex flex-col space-y-6 max-w-4xl mx-auto">
      <div className="bg-[#0096D6] text-white p-6 rounded-lg">
        <h1 className="text-3xl font-bold">HP Challenge 3: HP Amuse – Creative AI Artist</h1>
        ...
        {expandedSections.overview && (
          <div className="p-4">
            <p className="text-gray-700 mb-4">
              HP Amuse is an advanced creative AI tool built into HP AI laptops that enables users to generate 
              professional-quality images and written content. By combining powerful generative AI models with 
              HP's optimization technology, Amuse allows anyone to create compelling visual and written content 
          ...
          <div className="p-4">
            <div className="mb-4">
              ...
              <ol className="list-decimal pl-6 space-y-1 text-gray-700">
                ...
                <li>Open the HP Amuse application from your Start menu or desktop</li>
            ...
            <div className="mb-4">
              ...
              <ol className="list-decimal pl-6 space-y-1 text-gray-700">
                ...
                <li>Review the generated options (HP Amuse provides 4 variations for each prompt)</li>
              </ol>
            </div>
